...
def attack(char_name: str, char_class: str) -> str:
    """Высчитывается нанесенный урон в зависимости от выбранного класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Высчитывается блокированный урон в зависимости от класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Вычисляется нанесенный урон ультом в зависимости от класса."""
    if char_class == 'warrior':
